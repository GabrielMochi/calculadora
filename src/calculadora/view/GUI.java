...
import calculadora.controller.CacheController;
import calculadora.domain.Calculo;
import calculadora.repository.CalculoRepository;
...
public final class GUI extends javax.swing.JFrame {
    ...
    private static final String FILE_PATH = System.getenv("AppData") +
            File.separator +
            "mochi(x).json";
    
    private static final CacheController CACHE_CONTROLLER = new CacheController();
    private static final CalculoRepository CALCULO_REPOSITORY  = new CalculoRepository(FILE_PATH);
    ...
    public void windowEvents() {
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                try {
                    CALCULO_REPOSITORY.salvar(CACHE_CONTROLLER.getCalculos());
            ...
            public void windowOpened(WindowEvent e) {
                try {
                    ...
                    System.out.println(Arrays.toString(new GUI().getCALCULO_REPOSITORY().carregar()));
                } catch (IOException ex) {
                    Logger.getLogger(GUI.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private void initComponents() {
        ...
        register.setActionCommand("registro");
        register.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        register.setFont(new java.awt.Font("Consolas", 0, 12)); // NOI18N
        register.setLabel("Registro");
        ...
        down.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        ...
        up.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
                                        ...
                                        .addGroup(painelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, painelLayout.createSequentialGroup()
                                                ...
                                                .addGroup(painelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                    ...
                                                    .addComponent(up, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 51, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                .addGap(57, 57, 57)
            ...
            .addGroup(painelLayout.createSequentialGroup()
                ...
                .addGroup(painelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(painelLayout.createSequentialGroup()
                        ...
                        .addGap(2, 2, 2)
                        .addComponent(down, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(painel, javax.swing.GroupLayout.PREFERRED_SIZE, 494, Short.MAX_VALUE)
        );
    ...
    private void equalsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_equalsMouseClicked
        String solution = Motor.calcResultado(display.getText());
        result.setText(solution);
        CACHE_CONTROLLER.addCalculo(new Calculo(display.getText(), solution));
        CACHE_CONTROLLER.setLastCalculoHasBeenCalled(false);
    ...
    private void upMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_upMouseClicked
        Calculo calculo = CACHE_CONTROLLER.getPreviousCalculo();

        if (calculo != null) {
            display.setText(calculo.getFormula());
            result.setText(calculo.getResultado());
        }
    ...
    private void downMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_downMouseClicked
        Calculo calculo = CACHE_CONTROLLER.getNextCalculo();
    ...
    private void registerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_registerMouseClicked
        ...
        try {
            CALCULO_REPOSITORY.salvar(CACHE_CONTROLLER.getCalculos());
            Registro.launch(gson.toJson(CALCULO_REPOSITORY.carregar()));
        } catch (IOException ex) {
            Logger.getLogger(GUI.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_registerMouseClicked

    public static CacheController getCACHE_CONTROLLER() {
        return CACHE_CONTROLLER;
    }

    public static CalculoRepository getCALCULO_REPOSITORY() {
        return CALCULO_REPOSITORY;
    }
